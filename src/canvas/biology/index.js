...
import HumanHeartCanvas from "./humanheart/HumanHeartCanvas";
...
const humanheart = { title: 'Human Heart', canvas: <HumanHeartCanvas isExplorePage={true} />, description: `The human heart is a four-chambered muscular organ, roughly the size of a closed fist, with two-thirds of its mass to the left of midline. It is enclosed in a pericardial sac and consists of the epicardium, myocardium, and endocardium layers. The heart's chambers include the right atrium, right ventricle, left atrium, and left ventricle, each serving specific functions in blood circulation.` };
